    ...
    var stepTokenUpOrDown = /* @__PURE__ */ __name((type, current, options = defaultOptions) => {
      ...
      if (!(type in cacheVariables)) {
        ...
        for (const key in tokens2) {
          ...
          cacheVariables[type].push(tokens2[key]);
        }
      }
  ...
  "../node_modules/@tamagui/text/dist/cjs/wrapChildrenInText.js"(exports, module2) {
    ...
    function wrapChildrenInText2(TextComponent, propsIn, extraProps) {
      ...
      return import_react44.default.Children.toArray(children).map((child, index3) => {
        return typeof child === "string" ? /* @__PURE__ */ (0, import_jsx_runtime48.jsx)(TextComponent, { "data-disable-theme": true, ...props, ...textProps, children: child }, index3) : child;
      });
    }
...
function wrapChildrenInText(TextComponent, propsIn, extraProps) {
  ...
  return import_react20.default.Children.toArray(children).map((child, index3) => {
    return typeof child === "string" ? (
      // so "data-disable-theme" is a hack to fix themeInverse, don't ask me why
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(TextComponent, { "data-disable-theme": true, ...props, ...textProps, children: child }, index3)
    ) : child;
  });
}
...
var TooltipComponent = React36.forwardRef(/* @__PURE__ */ __name(function Tooltip(props, ref) {
  ...
  const twoSmallerKey = (0, import_get_token10.getSize)("$true", {
    shift: -2
  }).key;
...
var bodyFont = (0, import_font_inter.createInterFont)(
  ...
  {
    sizeSize: (size3) => Math.round(size3 * 1.1),
    sizeLineHeight: (size3) => Math.round(size3 * 1.1 + (size3 > 20 ? 10 : 10))
  }
);
